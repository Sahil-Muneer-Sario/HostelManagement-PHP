                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="customRadio1">Required <br><code>Additional charge: PKR 211 per month.</code></label>
                                </div>
                                <div class="custom-control custom-radio">
                ...
                <h4 class="card-title mt-5">Guardian's Information</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-subtitle"><code>Leave this checkbox unchecked if your permanent address is different.</code> </h6>
                                    <fieldset class="checkbox">
                                        <label>
                                            <input type="checkbox" value="1" name="adcheck"> I confirm that my permanent address is the same as the one mentioned above!
                                        </label>
                                    </fieldset>
                    ...
                    <h5 class="card-title mt-5">Please complete this section only if your permanent address is different.!</h5>
